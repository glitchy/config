...
local function buf_diagnostics_virtual_text(bufnr, diagnostics)
    ...
    for line, line_diags in pairs(buffer_line_diagnostics) do
        ...
        local decoration_width = util.window_decoration_columns()
        ...
        if #line_diags > 1 then
            ...
            local leading_space = available_space -
            ...
            table.insert(virt_texts, {
                prefix .. " ",
                vim.lsp.util.get_severity_highlight_name(line_diags[1].severity)
            })
...
local function show_line_diagnostics()
    ...
    for i, diagnostic in ipairs(line_diagnostics) do
        ...
        local hiname = vim.lsp.util.get_severity_highlight_name(
                           diagnostic.severity)
